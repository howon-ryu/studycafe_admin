...
import FullCalendar, { DateSelectArg, EventClickArg, EventContentArg,EventApi, EventAddArg, EventChangeArg, EventRemoveArg } from '@fullcalendar/react';
                        ...
                        <div id="kt_app_content_container"
                         >
                          ...
                          <div className="card card-flush h-xl-100 card__right"
                           css={
                            (!isOpenModal && !isOpenModal_view) ? css`
                            z-index:5000;
                            `
                            : css `
                            z-index:-1;
                            ...
                            <div className="modal-content">
                                <form onSubmit={handleSubmit}>
                                  <div className="modal-header">
                                        ...
                                        <h2 className="fw-bold" data-kt-calendar="title" >Add a New Event</h2>
                                  ...
                                  <div className="fv-row mb-9">
                                        ...
                                        <input type="text" id = "event_name" className="form-control form-control-solid" placeholder="" name="calendar_event_name" />
                                  ...
                                  <div className="fv-row mb-9">
                                    ...
                                    <input type="text" id = "event_description" className="form-control form-control-solid" placeholder="" name="calendar_event_description" />
                                  ...
                                  <div className="fv-row mb-9">
                                    ...
                                    <input type="text" id = "event_location" className="form-control form-control-solid" placeholder="" name="calendar_event_location" />
                                  ...
                                  <div className="fv-row mb-9">
                                    ...
                                    <label className="form-check form-check-custom form-check-solid">
                                      ...
                                      <label className="form-check-label fw-semibold" htmlFor="kt_calendar_datepicker_allday">All Day</label>
                                    </label>
                               ...
                               <button type="submit" id="kt_modal_add_event_submit" className="btn btn-primary">
                                 <span className="indicator-label"onClick={(e) => {
             console.log("!!!!!!!!!!!");
          // e.preventDefault();
                               ...
                               <div className="d-flex">
                                    ...
                                    <div className="mb-9">
                                      ...
                                      <div className="d-flex align-items-center mb-2">
                                        <span className="fs-3 fw-bold me-3" data-kt-calendar="event_name" >{title_text}</span>
                                        <span className="badge badge-light-success" data-kt-calendar="all_day"></span>
                                      </div>
                                      
                                      <div className="fs-6" data-kt-calendar="event_description">{description_text}</div>
                                ...
                                <div className="d-flex align-items-center mb-2">
                                    ...
                                    <div className="fs-6">
                                      ...
                                      <span data-kt-calendar="event_start_date">{start_time_text}</span>
                                    </div>
                                ...
                                <div className="d-flex align-items-center mb-9">
                                    ...
                                    <div className="fs-6">
                                      ...
                                      <span data-kt-calendar="event_end_date">{end_time_text}</span>
                                    </div>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="fs-6" data-kt-calendar="event_location">{locaion_text}</div>
