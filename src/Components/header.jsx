...
import d_small from "../assets/media/logos/default-small.svg";
  ...
  if (login_check) {
    return (
      ...
      >
        ...
        >
          <div className="header__navi_logo">
            <img
              alt="Logo"
              src={logo}
              color="black"
            ...
            <span className="fw-normal fs-5 ver_txt">ADMIN</span>
          </div>

          <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="../../demo1/dist/index.html" className="d-lg-none">
              <img alt="Logo" src={d_small} className="h-30px" />
            </a>
          </div>

          <div
            className="d-flex align-items-stretch flex-lg-grow-1 justify-content-end"
          ...
          >
            <div className="app-navbar flex-shrink-0">
              ...
              >
                <div
                  className="cursor-pointer symbol symbol-35px symbol-md-40px d-flex navbar__item_user"
