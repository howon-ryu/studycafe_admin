            ...
            <div
              ...
              >
                ...
                <div id="kt_app_content_container" className="app-container">
                  ...
                  <div
                    className="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10"
                  >
                    ...
                    <div className="card card-flush">
                      ...
                      <div className="card-header border-0 pt-5 stdy_w_rpt_top2">
                        ...
                        <div
                          className="d-flex align-items-center position-relative stdy_w_rpt_sch_w"
                        >
                          ...
                          >
                            ...
                            <thead>
                              ...
                              >
                                ...
                                <th className="min-w-50px text-end pe-5">
                                  전송유무
                                </th>
                              </tr>
                            </thead>
