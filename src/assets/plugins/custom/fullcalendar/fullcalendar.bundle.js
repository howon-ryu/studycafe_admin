...
var FullCalendar = (function (e) {
  ...
  function S(e) {
    ((!e.__d && (e.__d = !0) && a.push(e) && !w.__r++) ||
      l !== i.debounceRendering) &&
      ((l = i.debounceRendering) || s)(w);
  }
  function w() {
    for (var e; (w.__r = a.length); )
    ...
    for (n.__k = [], p = 0; p < t.length; p++)
      if (
        ...
        if (
          ((v.__ = n),
          (v.__b = n.__b + 1),
          null === (h = w[p]) || (h && v.key == h.key && v.type === h.type))
        )
          w[p] = void 0;
        else
          for (f = 0; f < D; f++) {
            if ((h = w[f]) && v.key == h.key && v.type === h.type) {
              w[f] = void 0;
              break;
            }
            h = null;
    ...
    for (n.__e = b, p = D; p--; )
      null != w[p] &&
        ("function" == typeof n.type &&
          ...
          (n.__d = E(r, p + 1)),
        A(w[p], w[p]));
    if (S) for (p = 0; p < S.length; p++) H(S[p], S[++p], S[++p]);
  }
  function T(e, t, n) {
    var r, o;
  ...
  function R(e, t, n, r, o) {
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (n) for (t in n) (r && n[t] === r[t]) || k(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      (i = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + i] = n),
        n
          ? r || e.addEventListener(t, i ? M : _, i)
          : e.removeEventListener(t, i ? M : _, i);
      ...
      e: if ("function" == typeof x) {
        if (
          ...
          null != x.getDerivedStateFromProps &&
            ...
            f(d.__s, x.getDerivedStateFromProps(b, d.__s))),
          (h = d.props),
          (v = d.state),
          p)
        )
        ...
        (d.context = w),
          ...
          D(e, Array.isArray(T) ? T : [T], t, n, r, o, a, s, l, u),
          (d.base = t.__e),
          (t.__h = null),
          d.__h.length && s.push(d),
          E && (d.__E = d.__ = null),
    ...
    if (null === m) v === g || (s && e.data === g) || (e.data = g);
      ...
      if (
        ((function (e, t, n, r, o) {
          var i;
          for (i in n)
            "children" === i || "key" === i || i in t || R(e, i, null, n[i], r);
          for (i in t)
      ...
      s ||
        ("value" in g &&
          ...
          R(e, "value", y, v.value, !1),
        "checked" in g &&
          void 0 !== (y = g.checked) &&
          y !== e.checked &&
          R(e, "checked", y, v.checked, !1));
    }
    return e;
  }
  function H(e, t, n) {
  ...
  function A(e, t, n) {
    ...
    if ((r = e.__k)) for (a = 0; a < r.length; a++) r[a] && A(r[a], t, n);
    null != o && h(o);
  }
  function O(e, t, n) {
  ...
  var De = /(top|left|right|bottom|width|height)$/i;
  function Te(e, t) {
    for (var n in t) xe(e, n, t[n]);
  }
  function xe(e, t, n) {
    null == n
      ? (e.style[t] = "")
      : "number" == typeof n && De.test(t)
      ? (e.style[t] = n + "px")
      : (e.style[t] = n);
  }
  function Ce(e) {
  ...
  function Ct(e, t, n) {
    ...
    for (var r in t) if (!(r in e) || !kt(e[r], t[r], n[r])) return !1;
  ...
  function En(e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = On(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  function An(e, t, n) {
    return void 0 === n && (n = On(t)), mn(e, n);
  }
  function On(e) {
    return r(r(r({}, Cn), Nn), e.pluginHooks.eventRefiners);
  }
  ...
  function Fn(e, t) {
    var n,
      ...
      o = [],
      i = t.start;
    for (e.sort(Bn), n = 0; n < e.length; n += 1)
  ...
  function Xn(e, t, n, r) {
    ...
    for (var c in i)
      for (var w = 0, D = Fn(i[c], n); w < D.length; w++) {
        S = D[w];
        s.push({
          def: e.defs[c],
          ui: u[c],
  ...
  function br(e, t, n, r) {
    ...
    for (var l in e.instances) {
      var u = e.instances[l];
      s = i.defs[u.defId];
      i.instances[l] = wr(u, s, o[u.defId], n, r);
    }
    return i;
  }
  function Sr(e, t, n, o) {
  ...
  function Cr(e) {
    return r(r(r({}, Cn), Tr), e.pluginHooks.eventSourceRefiners);
  }
  function kr(e, t) {
    return (
  ...
  var Rr = (function () {
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof _r) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({
                  type: "ADD_EVENTS",
                  eventStore: bn({ def: n, instance: r }),
                }),
          ...
          else if ("boolean" == typeof t) t && (o = Dt(i.eventSources)[0]);
          else if (null != t) {
          ...
          var s = Hn(e, o, i, !1);
          if (s) {
            var l = new _r(i, s.def, s.def.recurringDef ? null : s.instance);
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: bn(s) }),
        ...
        (e.prototype.getEventById = function (e) {
          ...
          for (var i in ((e = String(e)), r)) {
            var a = r[i];
            if (a.publicId === e) {
              if (a.recurringDef) return new _r(t, a, null);
              for (var s in o) {
                var l = o[s];
                if (l.defId === a.defId) return new _r(t, a, l);
              }
            }
          }
          return null;
  ...
  function Ir(e, t, n) {
    ...
    for (var s in o) {
      var l = o[s],
        u = r[l.defId];
      l.instanceId !== a && i.push(new _r(t, u, l));
    }
    return i;
  }
  var Pr = {};
      ...
      return (
        (e.prototype.splitProps = function (e) {
          var t = this,
            ...
            u = {};
          for (var c in ((this.eventUiBuilders = St(n, function (e, n) {
  ...
  if (
    ((To.prototype.classes = {}),
    (To.prototype.iconClasses = {}),
    (To.prototype.baseIconClass = ""),
    (To.prototype.iconOverridePrefix = ""),
    "undefined" == typeof FullCalendarVDom)
  )
    throw new Error(
      "Please import the top-level fullcalendar lib before attempting to import a plugin."
    );
  var xo = FullCalendarVDom.Component,
    Co = FullCalendarVDom.createElement,
    ko = FullCalendarVDom.render,
    Ro = FullCalendarVDom.createRef,
    _o = FullCalendarVDom.Fragment,
    ...
    Ao = Mo({});
  function Oo(e, t, n, r, o, i, a, s, l, u, c, d, p) {
    return {
      dateEnv: o,
      options: n,
      pluginHooks: a,
  ...
  var Lo = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(xt(e, this.props), xt(t, this.state)),
          !Ct(this.props, e, this.propEquality) ||
            !Ct(this.state, t, this.stateEquality)
        );
      }),
      (t.prototype.safeSetState = function (e) {
        Ct(this.state, r(r({}, this.state), e), this.stateEquality) ||
          this.setState(e);
      }),
  ...
  var Uo = (function (e) {
    ...
    return n(t, e), (t.contextType = Ao), t;
  })(Lo);
  function Wo(e) {
  ...
  var Yo = (function (e) {
    ...
    Zo = Mo(0);
  function Xo(e) {
    return Co(Zo.Consumer, null, function (t) {
      return Co(Ko, r({ renderId: t }, e));
    });
  }
  var Ko = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.innerElRef = Ro()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function Jo() {
    ...
    return function (r, o) {
      return (
        (t && Tt(t, o) && r === e) || ((e = r), (t = o), (n = Qo(r, o))), n
      );
    };
  }
  function Qo(e, t) {
    return "function" == typeof e && (e = e(t)), xn(e);
  }
  function ei(e, t) {
    return "function" == typeof e ? e(t, Co) : e;
  }
  var ti = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
  ...
  function ri(e) {
    ...
    return (
      n.content &&
        ((t = n),
        (o = function (e) {
          return Co(Ao.Consumer, null, function (n) {
            return Co(ti, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
      ...
      (e.prototype.buildCurrentRangeInfo = function (e, t) {
        ...
        return (
          r.duration
            ...
            : ((i = zt((o = this.getFallbackDuration())).unit),
              (a = this.buildRangeFromDuration(e, t, o, i))),
  ...
  function li(e, t, n, o) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return pi(
          e,
          t.sourceIds ? wt(t.sourceIds) : hi(e, o),
          s,
          t.isRefetch || !1,
          o
        );
  ...
  function gi(e, t, n, r, o) {
    switch (t.type) {
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, o, i) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (a = _t(a, r, i)), Dn(yi(e, t.sourceId), a);
          }
          return e;
      ...
      case "CHANGE_DATE":
      case "CHANGE_VIEW_TYPE":
        return r ? _t(e, r.activeRange, o) : e;
      case "REMOVE_EVENTS":
        return (function (e, t) {
          var n = e.defs,
            r = e.instances,
  ...
  function Di(e, t, n, r, o) {
    return {
      header: e.headerToolbar ? Ti(e.headerToolbar, e, t, n, r, o) : null,
      footer: e.footerToolbar ? Ti(e.footerToolbar, e, t, n, r, o) : null,
    };
  }
        ...
        return e.split(",").map(function (e) {
          ...
          if ((n = s[e]))
            ...
            if (
              ...
              y = Xe(c[b] || d[b], [u.year || "year", "year"], u[e]);
            } else
              y = function (t) {
  ...
  function Ri(e, t) {
    for (
      var n = Dt(t.getCurrentData().eventSources), r = [], o = 0, i = e;
      o < i.length;
      o++
    ) {
  ...
  var Ni = (function () {
    function e(e) {
      ...
      (this.computeOptionsData = qt(this._computeOptionsData)),
        ...
        (this.organizeRawLocales = qt(Vr)),
        (this.buildLocale = qt(Fr)),
        (this.buildPluginHooks = jo()),
        (this.buildDateEnv = qt(Hi)),
        (this.buildTheme = qt(Ai)),
        (this.parseToolbars = qt(Di)),
        (this.buildViewSpecs = qt(oi)),
        (this.buildDateProfileGenerator = Yt(Oi)),
        (this.buildViewApi = qt(Li)),
        (this.buildViewUiProps = Yt(zi)),
        (this.buildEventUiBySource = qt(Ui, Tt)),
        (this.buildEventUiBases = qt(Wi)),
        (this.parseContextBusinessHours = Yt(Fi)),
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : kr(s.now, l)),
      ...
      Vi(g, p) && this.emitter.trigger("loading", !0),
        (this.state = g),
        this.updateData(),
    ...
    return (
        ...
        var t = this,
          ...
          a = (function (e, t) {
            ...
            return "SET_OPTION" === t.type
              ? r(r({}, e), (((n = {})[t.optionName] = t.rawOptionValue), n))
              : e;
        ...
        for (
          var f = li(o.eventSources, e, p, c),
            ...
            b = {
              ...
              eventSelection: bi(o.eventSelection, e),
              eventDrag: Si(o.eventDrag, e),
              eventResize: wi(o.eventResize, e),
            },
            S = r(r({}, c), b),
            w = 0,
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = gn([cn, e, t]),
          ...
          u = this.buildPluginHooks(e.plugins || [], _i),
  ...
  function Hi(e, t, n, r, o, i, a, s) {
    var l = Fr(t || a.defaultCode, a.map);
    return new Lr({
    ...
    qi = (function () {
      ...
      return (
        ...
        (e.prototype.findInsertion = function (e) {
          ...
          var b = -1;
          return (
            E < a && n[E] === s && (b = Qi(r[E], e.span.end, Yi)[0]),
            {
              touchingLevel: l,
              touchingLateral: u,
              touchingEntry: c,
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          ...
          if (r.length > 1) {
            ...
            return Co.apply(void 0, o(["div", { className: m }], r));
          }
          return r[0];
        }),
        t
        ...
        return (
          (n.handleSegClick = function (e, t) {
            ...
            if (i && r.isValidSegDownEl(e.target)) {
              var a = be(e.target, ".fc-event-forced-url"),
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          (t && !r.isValidSegDownEl(t.target)) ||
            o.emitter.trigger(e, {
              el: n,
              event: new _r(o, i.eventRange.def, i.eventRange.instance),
              jsEvent: t,
              view: o.viewApi,
            });
        }),
  ...
  var ba = (function (e) {
                ...
                r(
                  {
                    ...
                    "data-date": u.isDisabled ? void 0 : Ft(s),
                    colSpan: a.colSpan,
                  },
                  a.extraDataAttrs
                ),
    ...
    Da = (function (e) {
      function t(t, n) {
        ...
        return (
          (r.initialNowDate = kr(n.options.now, n.dateEnv)),
  ...
  var xa = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.createDayHeaderFormatter = qt(Ca)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
        ...
        return Co(Da, { unit: "day" }, function (e, t) {
          return Co(
            "tr",
            { role: "row" },
            i && i("day"),
      ...
      !(
        ...
        !(function (e, t, n, o) {
          ...
          for (var m in u) {
            var y = u[m],
              ...
              b = c[y.defId],
              S = l[y.defId];
            if (!Aa(b.constraints, E, d, e.businessHours, t)) return !1;
            var w = t.options.eventOverlap,
              D = "function" == typeof w ? w : null;
            for (var T in f) {
              var x = f[T];
              if (qn(E, x.range)) {
                if (!1 === h[x.defId].overlap && a.isEvent) return !1;
                if (!1 === b.overlap) return !1;
                if (D && !D(new _r(t, p[x.defId], x), new _r(t, S, y)))
                  return !1;
              }
            }
            for (var C = i.eventStore, k = 0, R = b.allows; k < R.length; k++) {
              var _ = R[k],
                M = r(r({}, n), { range: y.range, allDay: S.allDay }),
                I = C.defs[S.defId],
                P = C.instances[m],
                N = void 0;
              if (((N = I ? new _r(t, I, P) : new _r(t, S)), !_(yr(M, t), N)))
                return !1;
            }
          }
          return !0;
        ...
        !(
          ...
          !(function (e, t, n, o) {
            ...
            o && (c = o(c));
            if (!Aa(c.constraints, u, i, e.businessHours, t)) return !1;
            ...
            for (var f in s) {
              ...
              if (qn(u, h.range)) {
                ...
                if (p && !p(new _r(t, a[h.defId], h), null)) return !1;
              }
            }
  ...
  function Aa(e, t, n, r, o) {
    for (var i = 0, a = e; i < a.length; i++) {
      if (!Ua(Oa(a[i], t, n, r, o), t)) return !1;
    }
    return !0;
  }
  ...
  function Fa(e) {
    for (
      var t = 0, n = 0, r = we(e, ".fc-scrollgrid-shrink");
      n < r.length;
      n++
    ) {
      var o = r[n];
  ...
  function ja(e, t) {
    return null != t.maxHeight || Ba(e, t);
  }
  function Ga(e, t, n, r) {
    var o = n.expandRows;
  ...
  function Ya(e, t) {
    ...
    return Co.apply(void 0, o(["colgroup", {}], n));
  }
  function Za(e) {
    return null == e ? 4 : e;
  }
  ...
  var ts = (function (e) {
    function t() {
      ...
      return (
        ...
        (t.scrollerRefs = new Va()),
        (t.scrollerElRefs = new Va(t._handleScrollerEl.bind(t))),
        (t.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Co(
          ...
          Boolean(!v && p.length) && Co.apply(void 0, o(["thead", g], p)),
          Boolean(!v && f.length) && Co.apply(void 0, o(["tbody", g], f)),
          Boolean(!v && h.length) && Co.apply(void 0, o(["tfoot", g], h)),
          v && Co.apply(void 0, o(o(o(["tbody", g], p), f), h))
        );
      }),
      (t.prototype.renderSection = function (e, t, n) {
        return "outerContent" in e
          ? Co(_o, { key: e.key }, e.outerContent)
          : Co(
              "tr",
              {
                key: e.key,
      ...
      (t.prototype.computeShrinkWidth = function () {
        return Xa(this.props.cols) ? Fa(this.scrollerElRefs.getAll()) : 0;
      }),
  ...
  ts.addStateEquality({ scrollerClientWidths: Tt, scrollerClientHeights: Tt });
  var ns = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = Ro()), t;
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            i = o.ui,
            a = {
              event: new _r(t, o.def, o.instance),
              view: t.viewApi,
              timeText: e.timeText,
            ...
            function (o, i, a, s, l) {
              return Co(
                ...
                Co(
                  "div",
                  {
                    className: "fc-event-mainaaaaaas",
                    ref: a,
    ...
    return Co(
      ...
      Co(
        ...
        Co(
          ...
          e.event.title || Co(_o, null, " ")
        )
      )
    );
  }
  var is = function (e) {
      return Co(Ao.Consumer, null, function (t) {
        var n = t.options,
          r = {
            isAxis: e.isAxis,
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this.props,
          ...
          i = r.isDisabled ? {} : { "data-date": Ft(e.date) };
        return Co(
          $o,
          {
            hookProps: r,
  ...
  function ps(e) {
    return (
      e.event.title && Co("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var fs = function (e) {
    return Co(Ao.Consumer, null, function (t) {
  ...
  var vs = (function (e) {
        ...
        (t.prototype.updateSize = function () {
          ...
          if (i) {
            var a = o.getBoundingClientRect(),
              s = r
                ? be(n, ".fc-scrollgrid").getBoundingClientRect().top
                : i.top,
            ...
            Te(o, { top: s - u.top, left: l - u.left });
          }
        }),
        t
      );
    ...
    ms = (function (e) {
      function t() {
        ...
        return (
          (t.linkElRef = Ro()),
          (t.state = { isPopoverOpen: !1, popoverId: _e() }),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            t = this.props,
            n = this.state;
          return Co(Ao.Consumer, null, function (r) {
            var o = r.viewApi,
              i = r.options,
              a = r.calendarApi,
              s = i.moreLinkText,
        ...
        (t.prototype.updateParentEl = function () {
          this.linkElRef.current &&
            (this.parentEl = be(this.linkElRef.current, ".fc-view-harness"));
        }),
        t
      );
    })(Uo);
  ...
  function Es(e) {
    ...
    var t,
      n = e.hiddenSegs;
    return { start: bs(n), end: ((t = n), t.reduce(ws).eventRange.range.end) };
  }
  function bs(e) {
                  ...
                  function (t, n, i, a) {
                    return (
                      ...
                      Co(
                        ...
                        Co(fa, r({ isHeightAuto: i, forPrint: a }, e))
                      )
                    );
                  }
                ),
    ...
    ks = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (xs += 1) &&
            window.addEventListener("touchmove", Rs, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (xs -= 1) ||
              window.removeEventListener("touchmove", Rs, { passive: !1 });
        }),
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target;
          return (
            !(!t || (this.handleSelector && !be(n, this.handleSelector))) &&
            ((this.subjectEl = t),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            !0)
  ...
  var _s = (function () {
    ...
    Is = (function (e) {
      function t(t, n) {
        return e.call(this, new wo(t), n) || this;
      }
      return (
        n(t, e),
        ...
        (e.prototype.queryScrollEls = function (e) {
          for (var t = [], n = 0, r = this.scrollQuery; n < r.length; n++) {
            ...
            "object" == typeof o
              ...
              : t.push.apply(
                  t,
                  Array.prototype.slice.call(ke(e).querySelectorAll(o))
                );
          }
          return t;
        }),
  ...
  var Ls = (function () {
    ...
    return (
      ...
      (e.prototype.prepareHits = function () {
        this.offsetTrackers = St(this.droppableStore, function (e) {
          return e.component.prepareHits(), new Os(e.el);
        });
      }),
    ...
    function t(n) {
      ...
      (o.subjectEl = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          (o.relevantEvents = Sn(l.getCurrentData().eventStore, c)),
          ...
          e.isTouch
            ...
            o.isDragging &&
              ...
              t.emitter.trigger("eventDragStart", {
                el: o.subjectEl,
                event: new _r(t, n.def, n.instance),
                jsEvent: e.origEvent,
                view: t.viewApi,
              }));
        }),
            ...
            o.displayDrag(a, c),
              ...
              t ||
                ...
                o.dragging.setMirrorIsVisible(
                  !e || !ke(o.subjectEl).querySelector(".fc-event-mirror")
                ),
          ...
          if (o.isDragging) {
            ...
            if (
              ...
              if (a === t) {
                ...
                t.emitter.trigger(
                  "eventLeave",
                  r(r({}, b), { draggedEl: e.subjectEl, view: n })
                ),
    ...
    function t(t) {
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleDragStart = function (e) {
          ...
          (n.draggingSegEl = o),
            ...
            t.emitter.trigger("eventResizeStart", {
              el: o,
              event: new _r(t, r.def, r.instance),
              jsEvent: e.origEvent,
              view: t.viewApi,
            });
        }),
        (n.handleHitUpdate = function (e, t, r) {
          ...
          l &&
            ((u = br(i, o.getCurrentData().eventUiBases, l, o)),
            (d.mutatedEvents = u),
  ...
  var js = (function () {
      function e(e) {
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            var n = t.context.options.unselectCancel,
              r = Ce(e.origEvent);
            (t.matchesCancel = !!be(r, n)),
              (t.matchesEvent = !!be(r, Fs.SELECTOR));
          }),
        ...
        var n = (this.documentPointer = new ks(document));
              ...
              if (
                ...
                o.dispatch({ type: "MERGE_EVENTS", eventStore: u }),
                  ...
                  o.emitter.trigger("eventReceive", {
                    event: new _r(o, i.def, i.instance),
                    relatedEvents: [],
                    revert: function () {
      ...
      return (
        ...
        (e.prototype.canDropElOnCalendar = function (e, t) {
          ...
          return "function" == typeof n
            ...
            : "string" != typeof n || !n || Boolean(Se(e, n));
        }),
        e
      );
    })();
  ...
  var Zs = (function () {
    ...
    $s = Bo({
      componentInteractions: [zs, Vs, Fs, Bs],
      calendarInteractions: [js],
      elementDraggingImpl: As,
      optionRefiners: Gs,
      listenerRefiners: qs,
    }),
    Js = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            Co(ti, { viewSpec: r.viewSpec }, function (e, t) {
              return Co(
                "div",
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          return (
            ...
            Co(ti, { viewSpec: a.viewSpec }, function (e, t) {
              return Co(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                Co(o, {
            ...
            function (e, t, u, c) {
              return Co(
                ...
                Co(
                  ...
                  Co("div", { className: "fc-daygrid-day-bg" }, n.bgContent)
                )
              );
            }
          );
  ...
  var vl = (function (e) {
    ...
    gl = (function (e) {
      function t() {
        ...
        return (
          (t.cellElRefs = new Va()),
          (t.frameElRefs = new Va()),
          (t.fgElRefs = new Va()),
          (t.segHarnessRefs = new Va()),
          (t.rootElRef = Ro()),
          (t.state = {
            framePositions: null,
          ...
          return Co(
            ...
            n.cells.map(function (t, r) {
              ...
              return Co(pl, {
                ...
                fgContent: Co(_o, null, Co(_o, null, o), Co(_o, null, i)),
                bgContent: Co(
                  _o,
                  null,
        ...
        (t.prototype.renderFgSegs = function (e, t, n, o, i, a, s) {
          ...
          if (c)
            for (var h = 0, v = t; h < v.length; h++) {
              ...
              S &&
                (l.isRtl
                  ? ((D = 0), (w = c.lefts[m.lastCol] - c.lefts[m.firstCol]))
                  : ((w = 0),
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                Co(
                  ...
                  "bg-event" === t ? Co(ds, r({ seg: c }, sr(c, i))) : cs(t)
                )
              );
            }
          return Co.apply(void 0, o([_o, {}], s));
        }),
          ...
          if (!t.forPrint && null !== t.clientWidth) {
            if (e) {
              ...
              if (o.length) {
                ...
                this.setState({ framePositions: new bo(i, o, !0, !1) });
              }
            }
  ...
  gl.addStateEquality({ eventInstanceHeights: Tt });
  var ml = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
  ...
  var El = (function (e) {
    ...
    bl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.slicer = new El()), (t.tableRef = Ro()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function wl(e, t) {
    var n = new ka(e.renderRange, t);
    return new Ra(n, /year|month|week/.test(e.currentRangeUnit));
  }
  var Dl = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
    ...
    Tl = Bo({
      ...
      views: {
        dayGrid: { component: Sl, dateProfileGeneratorClass: Dl },
  ...
  function kl(e) {
    ...
    return Co(Ao.Consumer, null, function (n) {
      if (!e.isLabeled)
        return Co("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return Co("tr", { key: e.key }, Co(kl, r({}, e)));
          });
        }),
        t
      );
                  ...
                  content: function (e) {
                    return Co(
                      ...
                      Co(
                        ...
                        e.tableColGroupNode,
                        Co("tbody", null, Co(_l, { slatMetas: i }))
                      ),
                      Co(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        Co(Da, { unit: h ? "minute" : "day" }, function (e) {
  ...
  var Nl = (function () {
    ...
    Al = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.rootElRef = Ro()), (t.slatElRefs = new Va()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  var ql = ln({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    Yl = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Co(
              rs,
              r({}, this.props, { defaultTimeFormat: ql, extraClassNames: e })
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Co(
            ...
            function (e, t) {
              return (
                t && Co("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            }
          );
        }),
    ...
    Xl = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          var n = this.props,
            o = this.context,
            i = Gl(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                var a = e[i];
                return Co(
                  "div",
                  ...
                  "bg-event" === t
                    ? Co(ds, r({ seg: a }, sr(a, n.todayRange, n.nowDate)))
                    : cs(t)
                );
              }
            );
  ...
  var Jl = (function (e) {
    function t() {
      ...
      return (
        ...
        (t.splitEventDrag = qt(Ll)),
        (t.splitEventResize = qt(Ll)),
        (t.rootElRef = Ro()),
        (t.cellElRefs = new Va()),
        t
      );
    ...
    nu = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Co(Da, { unit: a ? "minute" : "day" }, function (l, u) {
            return Co(
              Ql,
    ...
    for (
      var i = new Date(0),
        ...
        l =
          ...
          (function (e) {
            var t, n, r;
            for (t = ou.length - 1; t >= 0; t -= 1)
              if (null !== (r = Wt((n = Nt(ou[t])), e)) && r > 1) return n;
            return e;
          })(r),
        u = [];
      Ut(a) < Ut(t);
  ...
  var au = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.buildTimeColsModel = qt(su)), (t.buildSlatMetas = qt(iu)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  var du = ln({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
    pu = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
          ...
          return Co(
            ns,
            {
              ...
              defaultContent: function () {
                return (function (e, t) {
                  var n = cr(e, t);
                  return Co("a", r({}, n), e.eventRange.def.title);
                })(n, t);
              },
              isPast: e.isPast,
              isFuture: e.isFuture,
              ...
              return Co(
                ...
                (function (e, t, n, r, o) {
                  ...
                  if (!1 !== i.displayEventTime) {
                    ...
                    return Co("td", { className: "fc-list-event-time" }, u);
                  }
                  return null;
                })(n, s, t, o, a),
                Co(
  ...
  var hu = (function (e) {
    ...
    return (
        ...
        return Co(
          ...
          function (e, t, n, r) {
            return Co(
              ...
              Co("div", { className: "fc-list-empty-cushion", ref: n }, r)
            );
          }
        );
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return Co(Da, { unit: "day" }, function (e, n) {
          for (var a = [], d = 0; d < c.length; d += 1) {
            ...
            if (p) {
              var f = Ft(t[d]),
                h = u + "-" + f;
              a.push(
                Co(uu, { key: f, cellId: h, dayDate: t[d], todayRange: n })
              );
              for (
          ...
          return Co(
            ...
            Co(
              ...
              Co(
                "tr",
                null,
                Co("th", { scope: "col", id: s }, i.timeHint),
                Co("th", { scope: "col", "aria-hidden": !0 }),
                Co("th", { scope: "col", id: l }, i.eventHint)
              )
            ),
            Co("tbody", null, a)
          );
  ...
  var bu = Bo({ themeClasses: { bootstrap: Eu } }),
    Su = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
  ...
  var wu = Bo({ themeClasses: { bootstrap5: Su } }),
  ...
  return (
    ...
    (e.DayTableSlicer = El),
    (e.DayTimeCols = nu),
    (e.DayTimeColsSlicer = tu),
    (e.DayTimeColsView = au),
    (e.DelayedRunner = Mi),
    (e.Draggable = Zs),
    (e.ElementDragging = oa),
    (e.ElementScrollController = wo),
    (e.Emitter = Eo),
    (e.EventApi = _r),
    (e.EventRoot = ns),
    (e.EventSourceApi = ye),
    (e.FeaturefulElementDragging = As),
    (e.Fragment = _o),
    (e.Interaction = ea),
    (e.ListView = hu),
    (e.MoreLinkRoot = ms),
    ...
    (e.NowTimer = Da),
    (e.PointerDragging = ks),
    (e.PositionCache = bo),
    (e.RefMap = Va),
    (e.RenderHook = Yo),
    (e.ScrollController = So),
    ...
    (e.TimeCols = Ql),
    (e.TimeColsSlatsCoords = Nl),
    (e.TimeColsView = Il),
    (e.ViewApi = Dr),
    (e.ViewContextType = Ao),
    (e.ViewRoot = ti),
    (e.WeekNumberRoot = fs),
    (e.WindowScrollController = Do),
    (e.addDays = tt),
    (e.addDurations = At),
    (e.addMs = nt),
    (e.addWeeks = et),
    (e.allowContextMenu = Be),
    (e.allowSelection = Ve),
    (e.applyMutationToEventStore = br),
    (e.applyStyle = Te),
    (e.applyStyleProp = xe),
    ...
    (e.buildSlatMetas = iu),
    (e.buildTimeColsModel = su),
    (e.collectFromHash = Rt),
    (e.combineEventUis = _n),
    (e.compareByFieldSpec = qe),
    (e.compareByFieldSpecs = Ge),
    (e.compareNumbers = Ke),
    (e.compareObjs = Ct),
    (e.computeEarliestSegStart = bs),
    (e.computeEdges = ho),
    ...
    (e.elementMatches = Se),
    (e.enableCursor = We),
    (e.eventTupleToStore = bn),
    (e.filterEventStoreDefs = Tn),
    (e.filterHash = bt),
    ...
    (e.getUnequalProps = xt),
    (e.getUniqueDomId = _e),
    (e.globalLocales = Ur),
    (e.globalPlugins = _i),
    (e.greatestDurationDenominator = zt),
    ...
    (e.multiplyDuration = Ot),
    (e.padStart = Ze),
    (e.parseBusinessHours = Yr),
    (e.parseClassNames = xn),
    (e.parseDragMeta = sa),
    (e.parseEventDef = Ln),
    (e.parseFieldSpecs = je),
    (e.parseMarker = Or),
    (e.pointInsideRect = Zr),
    (e.preventContextMenu = Fe),
    (e.preventDefault = Me),
    (e.preventSelection = ze),
